...
import { Plus_Jakarta_Sans, Caveat, Geist_Mono, Poppins, Sora, Source_Serif_4, Syne, Tilt_Neon } from "next/font/google";
import "./globals.css";
...
export default async function RootLayout({
  ...
  return (
    <html
      ...
      className={`${poppins.variable} ${geistMono.variable} ${syne.variable} ${sourceSerif.variable} ${sora.variable} ${plusJakarta.variable} ${caveat.variable} ${tiltNeon.variable} h-full antialiased`}
